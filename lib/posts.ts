...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { p: 'The mistake is booking the clean for the same day as the walkthrough. If anything needs a second pass — a stubborn oven, a garage that turned out worse than expected — you have no room. Book the clean for the day before the inspection wherever you can. Around here, closings cluster at the end of the month, and so do move-out cleans, so a week of notice matters more in the last week of the month than the first.' },
  ...
  },
  {
    ...
    body: [
      ...
      { p: 'When somebody is crawling, the floor is the surface they touch most and the one closest to their face. That moves the priority from "looks clean" to "is clean and does not smell of anything." A floor that has been mopped with something strongly scented is not a neutral surface for a baby who is about to put their hands in their mouth.' },
      { h2: 'You can ask for water-only, and you should if you want it' },
      { p: 'This surprises people, so it is worth stating plainly: a great deal of household cleaning is mechanical rather than chemical. Hot water, a good microfibre cloth and actual pressure will handle most of a house. Chemicals earn their place in specific spots — a toilet, a kitchen after raw meat, mildew in grout — and are largely optional everywhere else.' },
      { p: 'If you want your floors and surfaces done with water only, ask for it. If you would rather we used products you have already chosen and left out, that works too. It is your house and your family, and no cleaner should make you feel awkward for having a preference.' },
      { h2: 'Pet hair is a vacuum problem, not a mopping problem' },
      { p: 'The most common complaint we hear from new clients about their last cleaner is hair reappearing a day later. That is usually because it was mopped over rather than lifted out. Hair works into the edges of rooms, the seam where carpet meets baseboard, and upholstery — and it has to come out of those places with suction and an edge tool before anything wet happens. If you have a shedding dog, that step is the one worth checking has been done.' },
