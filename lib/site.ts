...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    body: "We have been taking on larger commercial contracts since this summer. Offices, storefronts, salons, and churches across Duval, Clay, and St. Johns, cleaned on a schedule that stays out of your business day.",
    detail: [
...
const ROOMS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Shower head and faucets descaled",
      ...
      "Trash can emptied and wiped out",
